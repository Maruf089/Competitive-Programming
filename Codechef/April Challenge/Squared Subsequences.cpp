...
ll n,m,a,b,t,i,j,d,cs=0,counT=0,k,ans=0,l=0,sum1=0,sum=0,Max,Min,num,left_count,right_count,previ;
...
int main()
{
    ...
    while(t--)
    {
        ...
        int left = 0,cs=0 ;
//        f1(i,n)       /// continuous odd subarray count
//        {
//            if(arr[i]&1)
//                cs++;
//            else
