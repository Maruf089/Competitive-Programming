...
ll solve_area(int b,int e)
{
    if(b>e)
        return 0;
    if(b==e)
        return arr[b];
    int min_idx = query(1,1,n,b,e).second;
    //  dbg(b,e,min_idx);

    ll a1 = (e - b + 1 ) * arr[min_idx] ;
    ll a2 = max( solve_area(b,min_idx-1), solve_area(min_idx+1,e));
