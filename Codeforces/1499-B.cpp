...
int main()
{
  ...
  //      dbg(vc,vc1);
        ...
        {
            pos = it;
            o = 0 , z = 0 , prev = inf;counT = 0;
            for(i=pos-1;i>=0;i--) /// remove 1
            {
                if(s[i]=='1') counT++;
                if(s[i]=='1' and i+1 != prev)
                {
                    o++;
                    prev = i;
                }
        //        dbg(1,1,i,counT,o,prev);

            }

            ll counT1 = 0 ;
            prev = -8;
            for(i=pos+2;i<s.sz;i++) /// remove 0
            {
                if(s[i]=='0') counT1++;
                if(s[i]=='0' and i-1 != prev)
                {
                    z++;
                    prev = i;
                }
       //         dbg(1,2,i,counT1,z,prev);
            }

      //      dbg(counT,counT1 , o, z);

            if(counT==o and counT1==z)
            {
                paisi = 1;
                YES;
                break;
