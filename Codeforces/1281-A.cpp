...
int main()
{
    cin >> t ;
    string filip = "po";
    string japan = "desu",kor = "mnida",japan1 = "masu";
    while(t--)
    {
        cin >> s ;
        d = s.sz;
        int idx = 0,idx1 = 0,idx2=0,idx3=0;
        int ja = 0 ,ja1 = 0 ,pp = 0 ,kk=0;

            for(i=s.sz-4;i<s.sz;i++)
            {
                if(s[i]==japan[idx])
                    idx++;
                else
            ...
            if(idx2==4 and j==s.sz)
            {
                ja1 = 1 ;
            }

            if(s[s.sz-1]=='o' and s[s.sz-2]=='p')
            {
                pp = 1 ;
            }
