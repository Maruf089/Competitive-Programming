...
string s,s1;
ll n,m,a,b,i,j,d,t,x,y,z,cs=0,counT=0,k,ans=0,l=0,sum1=0,sum=0,Max,Min,num;
ll arr[10000000];
vector<ll>vc;
map<ll,ll>mp;
...
else if(b!=x and b!=y)z=b;
else if(cs!=x and cs!=y)z=cs;
else if(a!=x and a!=y)z=a;


if(z+d>y)ans+=(z+d)-y;
if(z-d<x)ans+= abs(z-d-x);
cout << ans << endl;
