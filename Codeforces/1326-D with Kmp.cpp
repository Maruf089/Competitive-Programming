...
int main()
{
    ...
    while(test--){
        ...
        string pref = prefix_func(tempStr);
        reverse(tempStr.begin(),tempStr.end());
        string suff = prefix_func(tempStr);
//dbg(pref,suff);
        if(pref.sz > suff.sz)
            ans += pref ;
        else ans += suff;
        ...
        if(cnt)
        {
            string x = str.substr(str.size()-cnt,str.size());
            ans += x ;
   //     dbg(x,ans);
        }
