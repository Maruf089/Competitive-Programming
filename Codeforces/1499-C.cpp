...
int main()
{
    ...
    while(t--)
    {
        ...
        f1(i,n)
        {
            ...
            else
            {
                ...
                if(Min2.sz==0)
                    ...
                    Min2.pb( min(Min2.back(),a) );
            }


        }

        ll cum[n+9] = {0}, cum1[n+9] = {0};
        f0(i,vc.sz) cum[i+1] = cum[i] + vc[i];
        f0(i,vc1.sz) cum1[i+1] = cum1[i] + vc1[i];
        ...
        for(i=n; i>=2; i--)
        {
            ...
            counT = cum[r1] + ( Min1[r1-1]* ( n - r1 ) );
            counT += cum1[u1] + ( Min2[u1-1] * (n - u1));
        ...
        for(i=n; i>=2; i--)
        {
            ...
            counT = cum[u1] + ( Min1[u1-1]* ( n - u1 ) );
            counT += cum1[r1] + ( Min2[r1-1] * (n - r1));
