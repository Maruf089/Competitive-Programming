...
ll arr[] = {0, 7, 97 , 199 , 2039 , 73984 , 100003 , 4301789 , 10000019 , 999999937};
...
int main()
{
    ...
    while(t--)
    {
        ...
        if(cs==1)
        {
           if(a==b) cout << arr[a] << ' ' << arr[b]-1 << ln;
           else  cout << arr[a] << ' ' << arr[b] << ln;
        }
        else
        {
