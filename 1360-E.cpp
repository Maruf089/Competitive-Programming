    ...
    while(t--)
    {
        ...
        f1(i,n)
        {
            ...
            f1(j,n)
            {
                ...
                {
        dbg(x,i,j);
                    int flag_right = 1, flag_lft = 1,flag_up = 1,flag_down = 1 ;
                    for(int ii = j ; ii <= n ; ii++) /// row check right
                    {
                        if(arr[i][ii]==0)
                        {
                            flag_right = 0 ;
                    ...
                    for(int ii = j ; ii >=1 ; ii--) /// row check left
                    {
                        if(arr[i][ii]==0)
                        {
                            flag_lft = 0 ;
                    ...
                    for(int ii = i ; ii <= n ; ii++) /// col check down
                    {
                        if(arr[ii][j]==0)
                        {
                            flag_down = 0 ;
                    ...
                    for(int ii = i ; ii >= 1 ; ii--) /// col check up
                    {
                        if(arr[ii][j]==0)
                        {
                            flag_up = 0 ;
                    ...
                    if(flag_right or flag_down)
                    {
                        its_ok = 1;
                    }
                    else if(flag_lft and flag_down)
                    {
                        its_ok = 1 ;
                    }
                    else if(flag_up and flag_right)
                    {
                        its_ok = 1 ;
                    }
                    else
